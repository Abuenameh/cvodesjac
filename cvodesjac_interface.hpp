...
namespace casadi {
  ...
  */
  class CASADI_INTEGRATOR_CVODES_EXPORT CvodesJacInterface : public SundialsInterface {
  public:
    /** \brief  Constructor */
    explicit CvodesJacInterface(const Function& f, const Function& g);

    /** \brief  Deep copy data members */
    virtual void deepCopyMembers(std::map<SharedObjectNode*, SharedObject>& already_copied);

    /** \brief  Clone */
    virtual CvodesJacInterface* clone() const;

    /** \brief  Create a new integrator */
    virtual CvodesJacInterface* create(const Function& f, const Function& g) const
    { return new CvodesJacInterface(f, g);}
