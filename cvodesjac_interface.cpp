...
#include "cvodesjac_interface.hpp"
...
namespace casadi {
  ...
  int CASADI_INTEGRATOR_CVODES_EXPORT
      casadi_register_integrator_cvodesjac(IntegratorInternal::Plugin* plugin) {
    plugin->creator = CvodesJacInterface::creator;
    plugin->name = "cvodesjac";
    plugin->doc = CvodesJacInterface::meta_doc.c_str();;
    plugin->version = 23;
    return 0;
  }

  extern "C"
  void CASADI_INTEGRATOR_CVODES_EXPORT casadi_load_integrator_cvodesjac() {
    IntegratorInternal::registerPlugin(casadi_register_integrator_cvodesjac);
  }

  CvodesJacInterface* CvodesJacInterface::clone() const {
    // Return a deep copy
    CvodesJacInterface* node = new CvodesJacInterface(f_, g_);
    node->jac_ = jac_;
    node->linsol_ = linsol_;
    return node;
  }

  CvodesJacInterface::CvodesJacInterface(const Function& f, const Function& g) : SundialsInterface(f, g) {
  ...
  void CvodesJacInterface::freeCVodes() {
  ...
  CvodesJacInterface::~CvodesJacInterface() {
    freeCVodes();
  }

  void CvodesJacInterface::init() {
  ...
  void CvodesJacInterface::initAdj() {
  ...
  void CvodesJacInterface::rhs(double t, const double* x, double* xdot) {
  ...
  int CvodesJacInterface::rhs_wrapper(double t, N_Vector x, N_Vector xdot, void *user_data) {
    try {
      casadi_assert(user_data);
      CvodesJacInterface *this_ = static_cast<CvodesJacInterface*>(user_data);
  ...
  void CvodesJacInterface::integrate(double t_out) {
  ...
  void CvodesJacInterface::resetB() {
  ...
  void CvodesJacInterface::integrateB(double t_out) {
  ...
  void CvodesJacInterface::printStats(std::ostream &stream) const {
    long nsteps, nfevals, nlinsetups, netfails;
    int qlast, qcur;
    double hinused, hlast, hcur, tcur;
    int flag = CVodeGetIntegratorStats(mem_, &nsteps, &nfevals, &nlinsetups, &netfails, &qlast,
  ...
  map<int, string> CvodesJacInterface::calc_flagmap() {
    map<int, string> f;
  ...
  map<int, string> CvodesJacInterface::flagmap = CvodesJacInterface::calc_flagmap();

  void CvodesJacInterface::cvodes_error(const string& module, int flag) {
    // Find the error
  ...
  void CvodesJacInterface::ehfun_wrapper(int error_code, const char *module, const char *function,
  ...
  void CvodesJacInterface::ehfun(int error_code, const char *module, const char *function, char *msg) {
    if (!disable_internal_warnings_) {
      userOut<true, PL_WARN>() << msg << endl;
    }
  }

  void CvodesJacInterface::rhsS(int Ns, double t, N_Vector x, N_Vector xdot, N_Vector *xF,
  ...
  int CvodesJacInterface::rhsS_wrapper(int Ns, double t, N_Vector x, N_Vector xdot, N_Vector *xF,
  ...
  void CvodesJacInterface::rhsS1(int Ns, double t, N_Vector x, N_Vector xdot, int iS, N_Vector xF,
                             N_Vector xdotF, N_Vector tmp1, N_Vector tmp2) {
    //    casadi_assert(Ns==nfdir_);
  ...
  int CvodesJacInterface::rhsS1_wrapper(int Ns, double t, N_Vector x, N_Vector xdot, int iS,
  ...
  int CvodesJacInterface::rhsQ_wrapper(double t, N_Vector x, N_Vector qdot, void *user_data) {
    try {
      casadi_assert(user_data);
      CvodesJacInterface *this_ = static_cast<CvodesJacInterface*>(user_data);
  ...
  void CvodesJacInterface::rhsQ(double t, const double* x, double* qdot) {
    // Pass input
    f_.setInputNZ(&t, DAE_T);
    f_.setInputNZ(x, DAE_X);
    f_.setInput(input(INTEGRATOR_P), DAE_P);
  ...
  void CvodesJacInterface::rhsQS(int Ns, double t, N_Vector x, N_Vector *xF, N_Vector qdot,
  ...
  int CvodesJacInterface::rhsQS_wrapper(int Ns, double t, N_Vector x, N_Vector *xF, N_Vector qdot,
  ...
  void CvodesJacInterface::rhsB(double t, const double* x, const double *rx, double* rxdot) {
  ...
  void CvodesJacInterface::rhsBS(double t, N_Vector x, N_Vector *xF, N_Vector rx, N_Vector rxdot) {
  ...
  int CvodesJacInterface::rhsB_wrapper(double t, N_Vector x, N_Vector rx, N_Vector rxdot,
                                   void *user_data) {
    try {
      casadi_assert(user_data);
      CvodesJacInterface *this_ = static_cast<CvodesJacInterface*>(user_data);
  ...
  int CvodesJacInterface::rhsBS_wrapper(double t, N_Vector x, N_Vector *xF, N_Vector xB,
  ...
  int CvodesJacInterface::rhsQB_wrapper(double t, N_Vector x, N_Vector rx,
  ...
  void CvodesJacInterface::rhsQB(double t, const double* x, const double* rx, double* rqdot) {
    if (monitor_rhsQB_) {
  ...
  int CvodesJacInterface::jtimes_wrapper(N_Vector v, N_Vector Jv, double t, N_Vector x,
  ...
  int CvodesJacInterface::jtimesB_wrapper(N_Vector vB, N_Vector JvB, double t, N_Vector x,
  ...
  void CvodesJacInterface::jtimes(N_Vector v, N_Vector Jv, double t, N_Vector x,
  ...
  void CvodesJacInterface::jtimesB(N_Vector vB, N_Vector JvB, double t, N_Vector x, N_Vector xB,
  ...
  int CvodesJacInterface::djac_wrapper(long N, double t, N_Vector x, N_Vector xdot, DlsMat Jac,
  ...
  int CvodesJacInterface::djacB_wrapper(long NeqB, double t, N_Vector x, N_Vector xB, N_Vector xdotB,
  ...
  void CvodesJacInterface::djac(long N, double t, N_Vector x, N_Vector xdot, DlsMat Jac,
  ...
  void CvodesJacInterface::djacB(long NeqB, double t, N_Vector x, N_Vector xB, N_Vector xdotB,
  ...
  int CvodesJacInterface::bjac_wrapper(long N, long mupper, long mlower, double t, N_Vector x,
  ...
  int CvodesJacInterface::bjacB_wrapper(long NeqB, long mupperB, long mlowerB, double t, N_Vector x,
  ...
  void CvodesJacInterface::bjac(long N, long mupper, long mlower, double t, N_Vector x, N_Vector xdot,
...
//    jac_.setInput(0.0, DAE_NUM_IN+1);
  ...
  void CvodesJacInterface::bjacB(long NeqB, long mupperB, long mlowerB, double t, N_Vector x,
  ...
  void CvodesJacInterface::setStopTime(double tf) {
    // Set the stop time of the integration -- don't integrate past this point
    int flag = CVodeSetStopTime(mem_, tf);
    if (flag != CV_SUCCESS) cvodes_error("CVodeSetStopTime", flag);
  }

  int CvodesJacInterface::psolve_wrapper(double t, N_Vector x, N_Vector xdot, N_Vector r,
  ...
  int CvodesJacInterface::psolveB_wrapper(double t, N_Vector x, N_Vector xB, N_Vector xdotB,
  ...
  int CvodesJacInterface::psetup_wrapper(double t, N_Vector x, N_Vector xdot, booleantype jok,
  ...
  int CvodesJacInterface::psetupB_wrapper(double t, N_Vector x, N_Vector xB, N_Vector xdotB,
  ...
  void CvodesJacInterface::psolve(double t, N_Vector x, N_Vector xdot, N_Vector r, N_Vector z,
  ...
  void CvodesJacInterface::psolveB(double t, N_Vector x, N_Vector xB, N_Vector xdotB, N_Vector rvecB,
  ...
  void CvodesJacInterface::psetup(double t, N_Vector x, N_Vector xdot, booleantype jok,
  ...
  void CvodesJacInterface::psetupB(double t, N_Vector x, N_Vector xB, N_Vector xdotB,
                               booleantype jokB, booleantype *jcurPtrB, double gammaB,
                               N_Vector tmp1B, N_Vector tmp2B, N_Vector tmp3B) {
  ...
  void CvodesJacInterface::lsetup(CVodeMem cv_mem, int convfail, N_Vector x, N_Vector xdot,
                              booleantype *jcurPtr,
  ...
  void CvodesJacInterface::lsetupB(double t, double gamma, int convfail,
  ...
  int CvodesJacInterface::lsetup_wrapper(CVodeMem cv_mem, int convfail, N_Vector x, N_Vector xdot,
                                     booleantype *jcurPtr,
                                     N_Vector vtemp1, N_Vector vtemp2, N_Vector vtemp3) {
    try {
      CvodesJacInterface *this_ = static_cast<CvodesJacInterface*>(cv_mem->cv_lmem);
      casadi_assert(this_);
  ...
  int CvodesJacInterface::lsetupB_wrapper(CVodeMem cv_mem, int convfail, N_Vector x, N_Vector xdot,
                                      booleantype *jcurPtr,
                                      N_Vector vtemp1, N_Vector vtemp2, N_Vector vtemp3) {
    try {
      CvodesJacInterface *this_ = static_cast<CvodesJacInterface*>(cv_mem->cv_lmem);
  ...
  void CvodesJacInterface::lsolve(CVodeMem cv_mem, N_Vector b, N_Vector weight,
  ...
  void CvodesJacInterface::lsolveB(double t, double gamma, N_Vector b, N_Vector weight,
  ...
  int CvodesJacInterface::lsolve_wrapper(CVodeMem cv_mem, N_Vector b, N_Vector weight,
                                     N_Vector x, N_Vector xdot) {
    try {
      CvodesJacInterface *this_ = static_cast<CvodesJacInterface*>(cv_mem->cv_lmem);
      casadi_assert(this_);
  ...
  int CvodesJacInterface::lsolveB_wrapper(CVodeMem cv_mem, N_Vector b, N_Vector weight,
                                      N_Vector x, N_Vector xdot) {
    try {
      CvodesJacInterface *this_ = static_cast<CvodesJacInterface*>(cv_mem->cv_lmem);
      casadi_assert(this_);
  ...
  void CvodesJacInterface::initDenseLinearSolver() {
  ...
  void CvodesJacInterface::initBandedLinearSolver() {
  ...
  void CvodesJacInterface::initIterativeLinearSolver() {
  ...
  void CvodesJacInterface::initUserDefinedLinearSolver() {
    // Make sure that a Jacobian has been provided
    if (jac_.isNull())
  ...
  void CvodesJacInterface::initDenseLinearSolverB() {
  ...
  void CvodesJacInterface::initBandedLinearSolverB() {
  ...
  void CvodesJacInterface::initIterativeLinearSolverB() {
    int flag;
    switch (itsol_g_) {
    case SD_GMRES:
  ...
  void CvodesJacInterface::initUserDefinedLinearSolverB() {
    // Make sure that a Jacobian has been provided
    if (jacB_.isNull())
  ...
  void CvodesJacInterface::deepCopyMembers(std::map<SharedObjectNode*, SharedObject>& already_copied) {
    SundialsInterface::deepCopyMembers(already_copied);
  }

  template<typename FunctionType>
  FunctionType CvodesJacInterface::getJacGen() {
  ...
  template<typename FunctionType>
  FunctionType CvodesJacInterface::getJacGenB() {
  ...
  Function CvodesJacInterface::getJacB() {
  ...
  Function CvodesJacInterface::getJac() {
      if (hasOption("full_jacobian")) {
      return getOption("full_jacobian");
      }
      else {
      throw CasadiException("CvodesJacInterfaceJac::getJac(): No jacobian set");
      }
